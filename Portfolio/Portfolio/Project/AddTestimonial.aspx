<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTestimonial.aspx.cs" Inherits="Portfolio.Project.AddTestimonial" MasterPageFile="~/Project/Admin.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <asp:Button ID="btnSave" runat="server" Text="Save Testimonial" OnClick="btnSave_Click" CssClass="btn btn-primary" />
