<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditSkill.aspx.cs" Inherits="Portfolio.Project.EditSkill"  MasterPageFile="~/Project/Admin.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <asp:Button ID="btnUpdate" runat="server" Text="Update Skill" OnClick="btnUpdate_Click" CssClass="btn btn-primary" />
