<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditTimelineEvent.aspx.cs" Inherits="Portfolio.Project.EditTimelineEvent" MasterPageFile="~/Project/Admin.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card">
        <div class="card-header">
            <h2>Edit Journey Event</h2>
        </div>
        <div class="card-body">
            <div class="mb-3">
            ...
            <asp:Button ID="btnUpdate" runat="server" Text="Update Event" OnClick="btnUpdate_Click" CssClass="btn btn-primary" />
